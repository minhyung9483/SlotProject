					...
					<div class="card-body p-4">
						...
						<div class="table-responsive">
							<table class="table text-nowrap mb-0 align-middle">
								...
								<tr>
									<td class=""><%--체크박스--%>
										<input type="checkbox" class="form-check-input" id="slotList<%=i%>" name="slotList" value="<%=slotList.get(i).getUSER_IDX()%>_<%=slotList.get(i).getSLOT_IDX()%>_<%=slotList.get(i).getNS_SLOT_TYPE_IDX()%>">
									</td>
									...
									<td class=""><%--번호--%>
										...
										<input type="hidden" id="TYPE_IDX_<%=slotList.get(i).getSLOT_IDX()%>" name="TYPE_IDX_<%=slotList.get(i).getSLOT_IDX()%>" value="<%=slotList.get(i).getNS_SLOT_TYPE_IDX()%>">
									</td>
									<%if("M".equals(member.getUSER_PERM())){%>
									<td class=""><%--상태--%>
