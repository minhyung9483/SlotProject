		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="updatesForm" name="updatesForm">
					...
					<div class="mb-3">
						<label for="PLCE_NAME_UPS" class="col-form-label">묶음MID</label>
						<input type="text" class="form-control PLCE_NAME_UPS" id="PLCE_NAME_UPS" name="PLCE_NAME_UPS">
					</div>
					<div class="mb-3">
						<label for="PLCE_CODE_UPS" class="col-form-label">단품MID</label>
					...
					<div class="mb-3">
						<label for="PLCE_URL_UPS" class="col-form-label">플레이스링크</label>
